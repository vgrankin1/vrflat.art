    ...
    update: function update() {
      ...
      if (this.data.enabled) {
        ...
        var options = {
          ...
          textVRNoHeadsetTip: this.data.textVRNoHeadsetTip,
...
var EnterVRButton = function (_EventEmitter) {
  ...
  function EnterVRButton(sourceCanvas, options) {
    ...
    options.textVRNoHeadsetTip = options.textVRNoHeadsetTip || 'No VR headset found.';
    options.textBrowserNSuported = options.textBrowserNSuported || 'Browser not supported';
      ...
      if (state != this.state) {
        ...
        switch (state) {
          ...
          case _states2.default.ERROR_BROWSER_NOT_SUPPORTED:
            ...
            this.setTooltip(this.options.textBrowserNSuported);//'Browser not supported'
            this.__setDisabledAttribute(true);
          ...
          case _states2.default.ERROR_NO_PRESENTABLE_DISPLAYS:
            this.show();
            this.setTitle(this.options.textVRNotFoundTitle);
            this.setTooltip( this.options.textVRNoHeadsetTip);//'No VR headset found.'
            this.__setDisabledAttribute(true);
            this.emit('error', new Error(state));
            break;
